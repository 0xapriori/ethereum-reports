...
There were also cases where the founders of crypto native media companies borrowed [$43 million](https://nypost.com/2022/12/12/michael-mccaffrey-bought-bahamas-pad-with-loans-from-sam-bankman-fried/) from the operator of a compromised centralized exchange (FTX). There has also been acquisitions of crypto native media companies which has led to censorship of certain points of view.
